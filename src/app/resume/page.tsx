...
function PDFViewer({
  ...
  return (
    ...
    >
      <div
        className={`relative bg-white dark:bg-gray-800 rounded-lg shadow-2xl flex flex-col ${
          isFullscreen
      ...
      >
        ...
        {/* PDF Embed */}
        <div
          className={`w-full max-w-7xl flex-grow bg-gray-200 rounded-b-lg overflow-hidden ${
