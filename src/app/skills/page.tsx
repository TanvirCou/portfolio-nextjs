        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-gray-600 dark:text-gray-400 text-lg max-w-3xl mx-auto'>
              An interactive overview of my technical expertise and the
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20'>
            {[
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${item.gradient} rounded-2xl opacity-50 blur-xl transition-opacity duration-500 group-hover:opacity-75`}
                ></div>
                <div className='relative bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-xl'>
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${item.gradient} flex items-center justify-center text-white mb-4`}
                  >
                    {item.icon}
                  </div>
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          <div className='mb-20'>
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={
                languagesInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
              transition={{ duration: 0.6 }}
          ...
          <div className='mb-20'>
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={
                developmentInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
              transition={{ duration: 0.6 }}
            ...
            >
              ...
              <div className='h-[400px]'>
                <Bar
                  data={getChartData(skills.development)}
                  options={barOptions}
                />
              </div>
            </motion.div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20'>
            ...
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={
                toolsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
              transition={{ duration: 0.6 }}
          ...
          <motion.div
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={
              learningInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
            }
            transition={{ duration: 0.6 }}
            className='bg-white dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20'
          >
