        ...
        <div className='mx-auto px-4 relative z-10'>
          <div className='flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-12 items-center pt-8 md:pt-0'>
            ...
            >
              ...
              <motion.div
                className='mt-12 mb-8 md:mb-0 flex gap-6 justify-center md:justify-start'
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className='hidden relative md:block w-full max-w-lg mx-auto order-3 md:order-2 pt-0 md:pt-0'
            ...
            >
              ...
              <div className='relative flex items-center justify-center min-h-[360px] md:min-h-[420px]'>
                <motion.div
                  className='relative z-20 w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-[360px] lg:h-[360px] group'
                  initial={{ opacity: 0, scale: 0.9, y: 20 }}
                  animate={{ opacity: 1, scale: 1, y: 0 }}
                  transition={{ duration: 0.9, delay: 0.1 }}
                >
                  <div className='absolute -inset-2 bg-gradient-to-r from-indigo-500 via-sky-500 to-emerald-500 rounded-[32px] opacity-40 blur-lg group-hover:opacity-50 transition-all duration-500'></div>
                  <div className='relative w-full h-full rounded-[34px] p-[2px] bg-gradient-to-tr from-indigo-500 via-sky-500 to-emerald-500 shadow-2xl shadow-indigo-500/30'>
                    <div className='relative w-full h-full rounded-[32px] bg-white/10 dark:bg-gray-900/50 border border-white/20 dark:border-gray-700/60 overflow-hidden backdrop-blur-xl'>
                      <Image
                        src='/assets/profile.jpeg'
                        alt={personalInfo.name}
                        fill
                      ...
                      <div className='absolute -top-12 -right-12 w-40 h-40 bg-white/20 blur-2xl'></div>
                    </div>
                  </div>
                </motion.div>
              </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {[
              ...
              },
              {
                ...
                image:
                  "https://i.ibb.co.com/GQppft75/Screenshot-2025-03-13-172955.png",
                tags: [
                  "Next.js",
                  "Prisma",
                  "PostgreSQL",
              ...
              <div className='flex flex-col md:flex-row items-center justify-between gap-8'>
                <div className='text-center md:text-left'>
                  ...
                  <p className='text-gray-600 dark:text-gray-400 max-w-2xl'>
                    Discover my complete portfolio featuring full-stack
                    applications, mobile apps, and innovative solutions across
                    various domains.
                  </p>
                </div>
                <Link href='/projects'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8'>
            {[
              ...
              },
              {
                name: "Next.js",
                level: "85%",
                icon: "/assets/icons/skills/nextjs.png",
              },
              {
                name: "Redux",
                level: "70%",
              ...
              },
              {
                name: "Firebase",
                level: "60%",
                icon: "/assets/icons/skills/firebase.svg",
              },
              {
                name: "Node.js",
                level: "55%",
              ...
              },
              {
                name: "Mongoose",
                level: "55%",
                icon: "/assets/icons/skills/mongoose.png",
              },
              {
                name: "Prisma",
                level: "50%",
                icon: "/assets/icons/skills/prisma.png",
              },
              {
                name: "PostgreSQL",
                level: "50%",
                icon: "/assets/icons/skills/postgresql.svg",
              },
              {
                name: "Git",
                level: "90%",
